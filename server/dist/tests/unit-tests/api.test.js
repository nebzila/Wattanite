...
const mockServer_1 = __importDefault(require("../helpers/mockServer"));
    ...
    photos: [
        {
            ...
            photo_reference: 'AcYSjRh3VcA1sTcEa9SvPK-NGX25WP_Hglhq_VLBeARHVPp8DXC9p-WWCCKknHILnsUe5p_u6fqOJMy6eVtKM0jeobfXq6js3rJptqXgP6x7pjMrmqod-mx_3A09j_p74BI9i3b_xbKcTEun1IlAHxfGKZ2tqEmfjX-Imx0-TjchPUOjleEq',
            width: 640,
            imgsrc: 'https://maps.googleapis.com/maps/api/place/photo?maxwidth=400&photoreference=AcYSjRh3VcA1sTcEa9SvPK-NGX25WP_Hglhq_VLBeARHVPp8DXC9p-WWCCKknHILnsUe5p_u6fqOJMy6eVtKM0jeobfXq6js3rJptqXgP6x7pjMrmqod-mx_3A09j_p74BI9i3b_xbKcTEun1IlAHxfGKZ2tqEmfjX-Imx0-TjchPUOjleEq&key=AIzaSyC8eBAJ7v_XgjPaI1UI7Qc_d04CndplLFs',
        },
    ],
...
describe('Test Handlers', function () {
    it('responds to get /', () => __awaiter(this, void 0, void 0, function* () {
        const response = yield mockServer_1.default.get('/movies');
        expect(response.status).toBe(200);
        expect(response.body.results[0].title).toBe('Bullet Train');
    }));
    it('post record', () => __awaiter(this, void 0, void 0, function* () {
        const response = yield mockServer_1.default.post('/create').send({
            name: 'Alex', postcode: 'SW3', movie: testMovie, restaurant: testRestaurant,
        });
